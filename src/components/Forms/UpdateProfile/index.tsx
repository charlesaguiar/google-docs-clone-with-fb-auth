...
const UpdateProfileForm: React.FC = () => {
	...
	const [avatar, avatarUrl, handleAvatarSubmit] = useFileReader(loggedUser?.avatarUrl)
	...
	return (
		<form className='flex flex-col gap-4' onSubmit={handleSubmit(onUpdateSubmit)}>
			<div className='flex flex-col gap-8 items-center md:flex-row'>
				<UploadAvatar avatarUrl={avatarUrl} handleAvatarSubmit={handleAvatarSubmit} />
			...
			<Divider />
			<Input id='email' label='Email' type='email' defaultValue={loggedUser.email ?? ''} disabled />
