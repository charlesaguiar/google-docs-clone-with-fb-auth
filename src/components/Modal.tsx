...
const Modal: React.FC<IModalProps> = ({ visible, toggleVisible = () => {}, title, children }) => {
		...
		<div className='flex items-center justify-center absolute inset-0 w-screen h-screen z-50 bg-backdrop'>
			...
			>
				...
				<div className='flex justify-between items-center p-4'>
					...
					<MdClose className='cursor-pointer' size={28} onClick={toggleVisible} />
				</div>
...
const useHideBodyScroll = (overflowVisible: boolean): void => {
	useLayoutEffect(() => {
