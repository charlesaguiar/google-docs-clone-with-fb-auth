...
import { MdHome, MdOutlineFolderOpen, MdFolderShared, MdPeopleAlt } from 'react-icons/md'
	...
	return (
		...
		>
			...
			<ul>
				...
				/>
				<MenuItem to='/shared-with-me' label='Shared With Me' Icon={<MdFolderShared size={28} />} />
